...
extension ContactLensesViewController: ARSCNViewDelegate {
    func renderer(_ renderer: SCNSceneRenderer, nodeFor anchor: ARAnchor) -> SCNNode? {
        ...
        rightEyeNode = ImageNode(width: 0.015, height: 0.015, image: #imageLiteral(resourceName: "Sharingan_3"))
        leftEyeNode = ImageNode(width: 0.015, height: 0.015, image: #imageLiteral(resourceName: "Sharingan_1"))
